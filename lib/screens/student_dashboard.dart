          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // Manually sort by appliedAt or fromDate since we removed orderBy to avoid index issues
                var docs = snapshot.data!.docs;
                docs.sort((a, b) {
                  Timestamp t1 = a['appliedAt'] ?? a['fromDate'];
                  Timestamp t2 = b['appliedAt'] ?? b['fromDate'];
